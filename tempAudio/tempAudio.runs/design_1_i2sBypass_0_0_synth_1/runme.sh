...
HD_PWD='D:/Stajnbrikner_studentskiRad19-20/DEMO_PROJECTS/tempAudio/tempAudio/tempAudio.runs/design_1_i2sBypass_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_i2sBypass_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_i2sBypass_0_0.tcl
